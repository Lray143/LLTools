...
import { STATUS_STYLES } from '../myAttendanceConstants'
...
export function MyAttendanceTable({ records, total, viewMode }) {
  ...
  const COLUMNS = [
    { label: 'Time Frame',  key: 'date',         width: '240px',  sortable: true  },
    { label: 'Shift In',    key: 'shiftIn',      width: '120px',  sortable: false },
    { label: 'Lunch Out',   key: 'lunchOut',     width: '120px',  sortable: false },
    { label: 'Lunch In',    key: 'lunchIn',      width: '120px',  sortable: false },
    { label: 'Shift Out',   key: 'shiftOut',     width: '120px',  sortable: false },
    { label: 'Total Hours', key: 'totalHours',   width: '160px',  sortable: true, isHours: true },
    { label: 'Status',      key: 'status',       width: '120px',  sortable: false },
  ]
                ...
                <tr>
                 ...
                 {Array.from({ length: PAGE_SIZE - 1 }).map((_, i) => (
                  <tr key={'empty-' + i} style={{
                    ...
                    <td colSpan={7} style={{ height: ROW_HEIGHT + 'px' }}></td>
                  </tr>
                ))}
              </>
            ) : (
