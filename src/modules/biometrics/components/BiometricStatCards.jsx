  ...
  return (
    <div className="grid grid-cols-7 gap-3">
      {cards.map((card) => (
        <div
          key={card.label}
          className="rounded-xl px-4 py-4 flex flex-col gap-1 bg-white border border-gray-200"
        >
          <p className="text-xs font-medium uppercase tracking-wider text-gray-400 leading-tight">
            {card.label}
          </p>
